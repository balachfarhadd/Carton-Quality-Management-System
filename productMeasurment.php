...
if(isset($_POST['submit'])){
    $measurement_value=$_POST['measurment'];
    $hobi=$_POST['hobie'];
    // $clear=$_POST['clear'];
    // $ds="DELETE FROM `project`.`measurmentproduct`";
    // $df=mysqli_query($conn,$ds);
    foreach($hobi as $hobies){
        //echo $hobies;
        $que="INSERT INTO `measurmentproduct` (catagori_id,measurement_value) VALUES ('$hobies','$measurement_value')";
    ...
    if (isset($_POST['delete'])) {
        $deleteQuery = "DELETE FROM measurmentproduct";
...
<body>
    ...
    <div class="parent">
        ...
        <div class="box1">
                ...
                <form action="productMeasurment.php"     method="POST"   >
                <div class="box3" style="display:flex;   margin-left:">
                    <button class="add">Add</button>
                    <button  type="submit"  class="add" name="delete"   >delete</button>
                </div>
                </form>
        ...
        <div class="form-heading">Add Product  Measurement</div>

        <form   method="POST"  action="productMeasurment.php">
        ...
        <div class="form-group">
        <label class="form-label" for="quantity">Measrement Value</label>
        <input type="text"  name="measurment"  required>
        </div>
 ...
 <?php
       $sql="SELECT  measurmentproduct.measurement_value,  measurmentproduct.measurment_id, product_categori.catagory_name
       FROM measurmentproduct
       INNER JOIN product_categori ON measurmentproduct.catagori_id =product_categori.catagori_id";
       $serial=0;
       ...
       <td>
       <a href="updatedMeasurment.php?id=' . $row['measurment_id'] . '" class="btn btn-primary">Edit</a>
        <a href="del.php?id=' . $row['measurment_id'] . '" class="btn btn-danger">Delete</a>
       </td>
       </tr>';
